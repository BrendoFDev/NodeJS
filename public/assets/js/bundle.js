...
___CSS_LOADER_EXPORT___.push([module.id, `body{
    margin:0;
    background: blue;
}`, "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,QAAQ;IACR,gBAAgB;AACpB","sourcesContent":["body{\n    margin:0;\n    background: blue;\n}"],"sourceRoot":""}]);
// Exports
...
alert("Essa ṕágina está sendo gerada");
})();
